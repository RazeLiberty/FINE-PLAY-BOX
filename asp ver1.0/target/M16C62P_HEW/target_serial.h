...
/*
 *		シリアルI/Oデバイス（SIO）ドライバ（RSK-M16C-62P用）
 */
 ...
 *  SIOの割込みハンドラのベクタ番号
 */
#define INHNO_SIO_TX	TINHNO_S0TNACK		/* 割込みハンドラ番号 */
#define INTNO_SIO_TX	TINTNO_S0TNACK		/* 割込み番号 */
#define INHNO_SIO_RX	TINHNO_S0RACK		/* 割込みハンドラ番号 */
#define INTNO_SIO_RX	TINTNO_S0RACK		/* 割込み番号 */
