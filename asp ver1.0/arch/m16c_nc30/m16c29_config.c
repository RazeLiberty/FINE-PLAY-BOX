...
volatile uint8_t * const intc_reg[INHNO_MAX] = 
{
	/* 0- */
	NULL ,	/* BRK */
	(volatile uint8_t *)TADR_SFR_C01WKIC ,	/* CAN0ウェイクアップ */
	(volatile uint8_t *)TADR_SFR_C0RECIC ,	/* CAN0受信 */
	(volatile uint8_t *)TADR_SFR_C0TRMIC ,	/* CAN0送信 */
	...
	/* 8- */
	(volatile uint8_t *)0x0048 ,			/* SIO4,INT5 */
	(volatile uint8_t *)0x0049 ,			/* SIO3,INT4 */
